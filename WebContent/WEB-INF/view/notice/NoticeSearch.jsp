...
<div>
    <div id="paging">
        <ul>
            <%if (startPage != 1) { %>
            <li><a href="/pagingList.do?nowPage=<%=startPage - 1%>&cntPerPage=<%=cntPerPage%>&keyword=<%=keyword%>&searchType=<%=searchType%>&category=<%=category_hit%>">&lt;</a>
                    <%
                            }
                            %> <%
 ...
 %>
            ...
            %>
            <li><a
                    href="/pagingList.do?nowPage=<%=j%>&cntPerPage=<%=cntPerPage%>&keyword=<%=keyword%>&searchType=<%=searchType%>&category=<%=category_hit%>"><%=j%></a></li>
            <%
                }
            %>
            <%
            ...
            %>
            <li><a
                    href="/pagingList.do?nowPage=<%=endPage + 1%>&cntPerPage=<%=cntPerPage%>&keyword=<%=keyword%>&searchType=<%=searchType%>&category=<%=category_hit%>">&gt;</a></li>
            <%
                }
            %>
        </ul>
