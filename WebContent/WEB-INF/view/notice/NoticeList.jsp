    ...
    <div class="about-area1 pb-bottom">
        ...
        <div class="row">
            <div class="row col-lg-4" id="paging">
                    <%if (startPage != 1) { %>
                        <div class="col-1 activeFocus"><a style="color: black" href="/pagingList.do?nowPage=<%=startPage - 1%>&cntPerPage=<%=cntPerPage%>&category=<%=category_hit%>"></a></div>
                ...
                <div class="col-1 activeFocus"><span><%=j%></span></div>
                    ...
                    <div class="col-1 activeFocus"><a style="color: black"
                            href="/pagingList.do?nowPage=<%=j%>&cntPerPage=<%=cntPerPage%>&category=<%=category_hit%>"><%=j%>
                    </a></div>
                    <%
                        }
                    %>
                    ...
                    %>
                    <div class="col-1 activeFocus"><a style="color: black"
                            href="/pagingList.do?nowPage=<%=endPage + 1%>&cntPerPage=<%=cntPerPage%>&category=<%=category_hit%>"></a>
                    </div>
                    <%
                        }
                    %>
...
<script type="text/javascript">    // 한 페이지당 게시물 보기 개수를 세팅하여 전달
function selChange() {
